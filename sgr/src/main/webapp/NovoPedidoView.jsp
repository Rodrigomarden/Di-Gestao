							...
							<table class="table table-bordered table-condensed">
			                    ...
			                    %>
									<tr>
										...
										<td>
											<form>
												<input id="quantPedido" min="1" value="1" type="number" style="width:50px" required></input>
											</form>
										</td>
										
										<td>
											<form>
												<a href="#" onclick="this.href='novo_pedido?operacao=adicionar&cod_comanda=<%=request.getAttribute("codigo_comanda")%>&codigo_produto=<%=p.getCodigo()%>&num_mesa=<%=request.getAttribute("num_mesa") %>&qntPedido='+document.getElementById('quantPedido').value" >
