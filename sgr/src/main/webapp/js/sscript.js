...
function modal_comanda(mesaAux) {
	window.open('garcom_comanda?num_mesa=' + mesaAux, "Garcom-Comanda","width=600, height=500, top=100, left=700, scrollbars=no, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no");
}

function modal_nova_comanda(mesaAux) {
	window.open('nova_comanda?num_mesa=' + mesaAux, "Nova_Comanda","width=600, height=250, top=100, left=700, scrollbars=no, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no");
}

function modal_novo_pedido(mesaAux) {
	window.open('novo_pedido?num_mesa=' + mesaAux, "Novo_Pedido","width=600, height=500, top=100, left=700, scrollbars=no, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no");
}
